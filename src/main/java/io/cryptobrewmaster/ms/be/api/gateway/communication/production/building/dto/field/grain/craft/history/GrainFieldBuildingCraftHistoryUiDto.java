package io.cryptobrewmaster.ms.be.api.gateway.communication.production.building.dto.field.grain.craft.history;
...
public class GrainFieldBuildingCraftHistoryUiDto {
    @NotNull
    private Long id;
    @NotNull
