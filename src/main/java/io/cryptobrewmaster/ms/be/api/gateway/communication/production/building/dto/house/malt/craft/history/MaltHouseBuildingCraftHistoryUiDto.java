package io.cryptobrewmaster.ms.be.api.gateway.communication.production.building.dto.house.malt.craft.history;
...
public class MaltHouseBuildingCraftHistoryUiDto {
    @NotNull
    private Long id;
    @NotNull
