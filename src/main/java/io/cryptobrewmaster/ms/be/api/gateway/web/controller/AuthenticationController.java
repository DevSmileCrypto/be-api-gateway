...
import io.cryptobrewmaster.ms.be.api.gateway.service.auth.AuthService;
...
public class AuthenticationController {
    ...
    public AuthenticationTokenPairDto refresh(@Valid @NotBlank @PathVariable String refreshToken) {
        ...
        AuthenticationTokenPairDto authenticationTokenPairDto = authenticationCommunicationService.tokenPairRefresh(refreshToken);
