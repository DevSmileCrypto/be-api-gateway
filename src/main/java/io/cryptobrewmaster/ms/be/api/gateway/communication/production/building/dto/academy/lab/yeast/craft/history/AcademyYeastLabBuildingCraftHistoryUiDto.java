package io.cryptobrewmaster.ms.be.api.gateway.communication.production.building.dto.academy.lab.yeast.craft.history;
...
public class AcademyYeastLabBuildingCraftHistoryUiDto {
    @NotNull
    private Long id;
    @NotNull
