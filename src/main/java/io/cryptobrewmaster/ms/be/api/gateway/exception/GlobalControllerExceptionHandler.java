...
public class GlobalControllerExceptionHandler {
    ...
    private void logWarning(HttpServletRequest request, RuntimeException exception) {
        log.warn(prepareErrorMessage(request, exception.getMessage()));
    }

    private String prepareErrorMessage(HttpServletRequest request, String errorMessage) {
