package io.cryptobrewmaster.ms.be.api.gateway.communication.production.building.dto.water.pump.craft.history;
...
public class WaterPumpBuildingCraftHistoryUiDto {
    @NotNull
    private Long id;
    @NotNull
