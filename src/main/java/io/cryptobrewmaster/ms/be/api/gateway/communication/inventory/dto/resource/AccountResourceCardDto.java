...
public class AccountResourceCardDto {
    @NotNull
    private Long id;
    @NotNull
    ...
    public static AccountResourceCardDto of(KafkaAccountResourceCard kafkaAccountResourceCard) {
        return new AccountResourceCardDto(
